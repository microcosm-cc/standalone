...
SET search_path = development, pg_catalog;
...
--
-- Name: development; Type: SCHEMA; Schema: -; Owner: microcosm
--
...
--
-- Name: effective_permissions; Type: TYPE; Schema: development; Owner: microcosm
--
...
--
-- Name: create_owned_site(character varying, character varying, bigint, bigint, character varying, bigint, character varying, character varying, text, character varying, character varying, character varying, character varying, character varying, character varying); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
--
-- Name: get_communication_options(integer, integer, integer, integer, integer); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
--
-- Name: get_effective_permissions(bigint, bigint, bigint, bigint, bigint); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
BEGIN
    ...
    IF (mid > 0 AND inItemTypeId IN (1,3,4,5,13,14,15,16,17,18,19)) THEN
    ...
    IF mid = 0 THEN
        ...
        CASE inItemTypeId
        WHEN 1 THEN -- Site
            -- Sites do not belong to Microcosms
        WHEN 2 THEN -- Microcosm
            mid := inItemId;
        WHEN 3 THEN -- Profile
            -- Profiles do not belong to Microcosms
        WHEN 4 THEN -- Comment
            SELECT COALESCE(f.microcosm_id, 0)
             ...
             WHERE f.item_type_id = 4
              ...
              INTO mid
                  ...
                  ,parent_item_id;
        WHEN 5 THEN -- Huddle
            -- Huddles do not belong to Microcosms
        ...
        WHEN 13 THEN -- Attendee
            SELECT i.microcosm_id
             ...
             WHERE a.attendee_id = inItemId
              ...
              INTO mid;
        WHEN 14 THEN -- User
            -- Users do not belong to Microcosms
        WHEN 15 THEN -- Attribute
            ...
            END IF;
        WHEN 16 THEN -- Alert
            -- Alerts do not belong to Microcosms
        WHEN 17 THEN -- Role
        WHEN 18 THEN -- AlertType
            -- AlertTypes do not belong to Microcosms
    ...
    IF $5 > 0 THEN
        ...
        SELECT (owned_by = inProfileId)
              ,(owned_by = inProfileId)
          FROM sites
        ...
        IF result.is_superuser = false AND mid > 0 THEN
            -- Else look it up
            IF (SELECT COUNT(*) FROM roles rr WHERE rr.microcosm_id = mid) > 0 THEN
                -- microcosm roles
                SELECT (COUNT(*) > 0)
...
--
-- Name: get_microcosm_permissions_for_profile(bigint, bigint, bigint); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
--
-- Name: get_microcosm_roles(bigint, bigint); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
--
-- Name: get_role_profile(bigint, bigint, bigint); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
--
-- Name: get_role_profiles(bigint, bigint); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
--
-- Name: has_unread(bigint, bigint, bigint); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
--
-- Name: is_attending(bigint, bigint); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
--
-- Name: is_banned(bigint, bigint, bigint); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
--
-- Name: is_deleted(bigint, bigint); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
--
-- Name: last_read_time(bigint, bigint, bigint); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
--
-- Name: update_comments_flags(); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
--
-- Name: update_comments_search_index(); Type: FUNCTION; Schema: development; Owner: microcosm
--
        ...
        ELSIF (TG_OP = 'UPDATE') THEN
            ...
            UPDATE search_index
               SET parent_item_type_id = NEW.item_type_id
                  ,parent_item_id = NEW.item_type_id
             WHERE item_type_id = 4
               AND item_id = NEW.comment_id;
...
--
-- Name: update_conversations_flags(); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
--
-- Name: update_conversations_search_index(); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
--
-- Name: update_events_flags(); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
--
-- Name: update_events_search_index(); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
--
-- Name: update_huddles_flags(); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
--
-- Name: update_huddles_search_index(); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
--
-- Name: update_microcosms_flags(); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
--
-- Name: update_microcosms_search_index(); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
--
-- Name: update_polls_flags(); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
--
-- Name: update_profiles_flags(); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
--
-- Name: update_profiles_search_index(); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
--
-- Name: update_revisions_search_index(); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
--
-- Name: update_sites_flags(); Type: FUNCTION; Schema: development; Owner: microcosm
--
...
--
-- Name: access_tokens; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: access_tokens_access_token_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: access_tokens_access_token_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: activity_scores; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE activity_scores; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: admins; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE admins; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: updates; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE updates; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN updates.item_id; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: alerts_alert_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: alerts_alert_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: attachment_meta; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE attachment_meta; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: attachment_meta_attachment_meta_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: attachment_meta_attachment_meta_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: attachment_views; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE attachment_views; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: attachments; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE attachments; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN attachments.item_id; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: attachments_attachment_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: attachments_attachment_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: attendee_state; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: attendees; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: COLUMN attendees.profile_id; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN attendees.created_by; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: attendees_attendee_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: attendees_attendee_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: attribute_keys; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE attribute_keys; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: attribute_values; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE attribute_values; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: attributes_attribute_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: attributes_attribute_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: banned_emails; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE banned_emails; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: bans; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE bans; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: bans_ban_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: bans_ban_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: choices; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE choices; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: choices_choice_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: choices_choice_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: comments; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE comments; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN comments.item_id; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: comments_comment_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: comments_comment_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: conversations; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE conversations; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: conversations_conversation_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: conversations_conversation_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: criteria; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE criteria; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN criteria.criteria_id; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN criteria.role_id; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN criteria.or_group; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN criteria.profile_column; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN criteria.key; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN criteria.type; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN criteria.predicate; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN criteria.value; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: criteria_criteria_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: criteria_criteria_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: disabled_roles; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE disabled_roles; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: events; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: COLUMN events.is_full; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: events_event_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: events_event_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: flags; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: follows; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE follows; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: huddle_profiles; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE huddle_profiles; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: huddles; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE huddles; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: huddles_huddle_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: huddles_huddle_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: TABLE import_origins; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN import_origins.product; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: import_origins_origin_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: import_origins_origin_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: imported_items; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE imported_items; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN imported_items.item_id; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: ips; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: item_types; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE item_types; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN item_types.rank; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: links; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE links; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: links_link_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: links_link_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: menus; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE menus; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN menus.menu_id; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN menus.href; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN menus.title; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN menus.text; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN menus.sequence; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: menus_menu_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: menus_menu_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: metrics; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: microcosm_options; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: microcosm_profile_options; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: microcosm_profile_options_microcosm_profile_option_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: microcosm_profile_options_microcosm_profile_option_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: microcosms; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE microcosms; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: microcosms_microcosm_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: microcosms_microcosm_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: moderation_queue; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE moderation_queue; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN moderation_queue.item_id; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: moderation_queue_moderation_queue_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: moderation_queue_moderation_queue_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: oauth_clients; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE oauth_clients; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: oauth_clients_client_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: oauth_clients_client_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: platform_options; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: polls; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE polls; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: polls_poll_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: polls_poll_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: privacy_options; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE privacy_options; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: profiles; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE profiles; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: users; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE users; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: profile_filter; Type: VIEW; Schema: development; Owner: microcosm
--
...
--
-- Name: profile_options; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE profile_options; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: profiles_profile_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: profiles_profile_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: read; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE read; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN read.item_id; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: read_read_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: read_read_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: revision_links; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE revision_links; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: revision_links_revlinks_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: revision_links_revlinks_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: revisions; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE revisions; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: revisions_revision_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: revisions_revision_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: rewrite_domain_rules; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: rewrite_domains; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: rewrite_domains_domain_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: rewrite_domains_domain_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: rewrite_rules; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE rewrite_rules; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: role_members_cache; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: role_profiles; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE role_profiles; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: roles; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE roles; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN roles.title; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN roles.site_id; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN roles.microcosm_id; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN roles.created_by; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN roles.is_moderator_role; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN roles.is_banned_role; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN roles.can_read; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN roles.can_create; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN roles.can_update; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN roles.can_delete; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN roles.can_close_own; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN roles.can_open_own; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN roles.can_read_others; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: roles_role_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: roles_role_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: schema_migrations; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: search_index; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: site_options; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: site_stats; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: sites; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE sites; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN sites.domain; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: sites_site_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: sites_site_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: themes; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE themes; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: themes_theme_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: themes_theme_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: update_options; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE update_options; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: update_options_defaults; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE update_options_defaults; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: update_types; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE update_types; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: url_rewrites_url_rewrite_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: url_rewrites_url_rewrite_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: users_user_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: users_user_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: value_types; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: views; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE views; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: votes; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE votes; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: watchers; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: watchers_watcher_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: watchers_watcher_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: ymg; Type: TABLE; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: TABLE ymg; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: COLUMN ymg.item_id; Type: COMMENT; Schema: development; Owner: microcosm
--
...
--
-- Name: ymg_ymg_id_seq; Type: SEQUENCE; Schema: development; Owner: microcosm
--
...
--
-- Name: ymg_ymg_id_seq; Type: SEQUENCE OWNED BY; Schema: development; Owner: microcosm
--
...
--
-- Name: access_token_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: attachment_meta_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: attachment_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: attendee_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: attribute_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: ban_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: choice_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: comment_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: conversation_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: criteria_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: event_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: huddle_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: origin_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: link_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: menu_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: microcosm_profile_option_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: microcosm_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: moderation_queue_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: client_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: poll_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: profile_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: read_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: revlinks_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: revision_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: domain_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: rule_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: role_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: site_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: theme_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: update_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: user_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: watcher_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: ymg_id; Type: DEFAULT; Schema: development; Owner: microcosm
--
...
--
-- Name: access_tokens_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: access_tokens_token_value_key; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: admins_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: admins_site_id_key; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: alert_defaults_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: alert_preferences_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: alert_types_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: alerts_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: attachment_id_pk; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: attachment_meta_id_pk; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: attachment_view_id_pk; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: attendee_state_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: attendee_state_title_key; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: attendees_event_id_profile_id_key; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: attendees_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: attributes_item_type_id_item_id_name_key; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: attributes_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: banned_emails_pk; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: bans_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: comments_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: conversations_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: criteria_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: disabled_roles_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: events_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: flags_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: follows_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: huddle_recipients_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: huddles_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: import_origins_title_key; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: imported_items_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: ips_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: item_type_id_pk; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: links_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: links_short_url_key; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: links_url_key; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: menus_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: menus_site_id_sequence_key; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: metrics_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: microcosm_id_pk; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: microcosm_options_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: microcosm_profile_options_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: moderation_queue_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: oauth_clients_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: poll_choices_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: polls_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: privacy_options_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: profile_options_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: profiles_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: profiles_site_id_user_id_key; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: read_id_pk; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: revision_links_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: revisions_comment_id_created_key; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: revisions_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: rewrite_domain_rules_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: rewrite_domains_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: role_members_cache_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: role_profiles_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: roles_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: schema_migrations_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: search_index_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: site_id_pk; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: site_id_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: site_options_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: sites_domain_key; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: sites_subdomain_key_key; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: themes_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: url_rewrite_id_pk; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: users_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: value_types_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: value_types_title_key; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: values_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: votes_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: watchers_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: watchers_profile_id_item_type_id_item_id_key; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: ymg_pkey; Type: CONSTRAINT; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: attachments_itemtypeandid_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: attribute_keys_itemtypeandid_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: comments_in_reply_to; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: comments_isdeleted_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: comments_ismoderated_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: comments_itemtypeandid_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: conversations_isdeleted_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: conversations_microcosmid_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: events_isdeleted_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: events_microcosmid_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: flags_createdby_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: flags_deleted_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: flags_microcosmid_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: flags_parentitemtypeidandparentitemid_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: flags_partial_item_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: huddles_huddleprofileid_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: huddles_profileid_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: ips_action_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: ips_ip_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: ips_profileid_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: ips_seen_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: ips_siteid_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: item_types_rank_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: microcosms_created_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: microcosms_is_deleted_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: microcosms_isdeleted_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: microcosms_last_comment_created_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: moderation_queue_itemtypeandid_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: parent_modified_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: polls_isdeleted_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: polls_microcosmid_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: read_partial_order_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: read_profileitemtypeandid_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: read_profileitemtypeid_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: searchindex_documentvector_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: searchindex_itemtypeidanditemid_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: searchindex_parentitemtypeidandparentitemid_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: searchindex_profileid_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: searchindex_siteid_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: searchindex_titlevector_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: updates_forprofile_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: updates_itemtypeandid_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: views_item_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: views_itemtype_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: watchers_itemtypeandid_idx; Type: INDEX; Schema: development; Owner: microcosm; Tablespace: 
--
...
--
-- Name: comments_flags; Type: TRIGGER; Schema: development; Owner: microcosm
--
...
--
-- Name: comments_search_index; Type: TRIGGER; Schema: development; Owner: microcosm
--
...
--
-- Name: conversations_flags; Type: TRIGGER; Schema: development; Owner: microcosm
--
...
--
-- Name: conversations_search_index; Type: TRIGGER; Schema: development; Owner: microcosm
--
...
--
-- Name: events_flags; Type: TRIGGER; Schema: development; Owner: microcosm
--
...
--
-- Name: events_search_index; Type: TRIGGER; Schema: development; Owner: microcosm
--
...
--
-- Name: huddles_flags; Type: TRIGGER; Schema: development; Owner: microcosm
--
...
--
-- Name: huddles_search_index; Type: TRIGGER; Schema: development; Owner: microcosm
--
...
--
-- Name: microcosms_flags; Type: TRIGGER; Schema: development; Owner: microcosm
--
...
--
-- Name: microcosms_search_index; Type: TRIGGER; Schema: development; Owner: microcosm
--
...
--
-- Name: polls_flags; Type: TRIGGER; Schema: development; Owner: microcosm
--
...
--
-- Name: profiles_flags; Type: TRIGGER; Schema: development; Owner: microcosm
--
...
--
-- Name: profiles_search_index; Type: TRIGGER; Schema: development; Owner: microcosm
--
...
--
-- Name: revisions_search_index; Type: TRIGGER; Schema: development; Owner: microcosm
--
...
--
-- Name: sites_flags; Type: TRIGGER; Schema: development; Owner: microcosm
--
...
--
-- Name: access_tokens_client_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: access_tokens_user_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: activity_scores_item_type_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: activity_scores_site_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: admins_profile_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: admins_site_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: alert_defaults_alert_type_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: alert_preferences_alert_type_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: alert_preferences_profile_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: alerts_alert_type_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: alerts_alerted_profile_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: alerts_item_type_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: alerts_profile_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: alerts_site_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: attachment_views_attachment_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: attachments_attachment_meta_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: attachments_item_type_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: attachments_profile_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: attendees_created_by_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: attendees_edited_by_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: attendees_event_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: attendees_profile_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: attendees_state_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: attributes_item_type_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: banned_emails_site_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: banned_emails_user_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: bans_site_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: bans_user_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: comments_item_type_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: comments_profile_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: conversations_created_by_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: conversations_edited_by_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: conversations_microcosm_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: criteria_role_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: disabled_roles_microcosm_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: disabled_roles_role_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: events_microcosm_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: flags_created_by_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: flags_item_type_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: flags_parent_item_type_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: flags_site_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: follows_follow_profile_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: follows_profile_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: huddle_recipients_huddle_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: huddle_recipients_profile_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: huddles_created_by_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: huddles_site_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: imported_items_item_type_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: imported_items_origin_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: menus_site_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: microcosm_options_microcosm_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: microcosm_profile_options_microcosm_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: microcosm_profile_options_profile_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: microcosms_created_by_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: microcosms_last_comment_created_by_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: microcosms_last_comment_item_type_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: microcosms_site_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: moderation_queue_item_type_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: moderation_queue_microcosm_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: moderation_queue_profile_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: poll_choices_poll_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: polls_created_by_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: polls_edited_by_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: polls_microcosm_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: privacy_options_profile_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: profile_options_profile_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: profiles_avatar_attachment_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: profiles_site_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: profiles_user_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: read_item_type_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: read_profile_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: revision_links_link_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: revisions_comment_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: revisions_profile_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: rewrite_domain_rules_domain_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: rewrite_domain_rules_rule_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: role_profiles_profile_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: role_profiles_role_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: roles_created_by_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: roles_edited_by_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: roles_microcosm_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: roles_site_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: search_index_item_type_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: search_index_parent_item_type_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: site_options_site_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: sites_theme_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: values_attribute_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: values_value_type_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: votes_choice_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: votes_poll_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: votes_user_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: watchers_item_type_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: watchers_profile_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: ymg_item_profile_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: ymg_item_type_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
...
--
-- Name: ymg_profile_id_fkey; Type: FK CONSTRAINT; Schema: development; Owner: microcosm
--
